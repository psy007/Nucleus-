...
<body>
	...
	<div id="content">
		<a href="profile.php" style="background-color:rgba(44, 62, 80,1.0);">
        	<div>
            	<img src="images/profile.png" width="100px" height="auto" />
                <p>Profile</p>
            </div>
        </a>
    	<a href="attendance.php" style="background-color:rgba(153,0,102,1);">
        	<div>
            	<img src="images/attend.png" width="100px" height="auto" />
            	<p>Attendance</p>
            </div>
        </a>
    	<a href="marks.php" style="background-color:rgba(153,51,0,1);">
        	<div>
            	<img src="images/marks.png" width="100px" height="auto" />
            	<p>Marks</p>
            </div>
        </a>
    	<a href="notify.php" style="background-color:rgba(102,0,102,1);">
        	<div>
